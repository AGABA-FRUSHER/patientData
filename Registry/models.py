...
class AdministeredAncillaryCare(models.Model):
    ...
    administered_by = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
...
class AdministeredAncillaryCareInventoryItem(models.Model):
    ...
    branch = models.ForeignKey('Branch', models.DO_NOTHING)
    company = models.ForeignKey('Company', models.DO_NOTHING)
    cost_of_goods_sold_journal_entry = models.ForeignKey('GeneralJournal', models.DO_NOTHING, blank=True, null=True)
    created_by = models.ForeignKey('SystemUser', models.DO_NOTHING)
    date_created = models.DateTimeField(blank=True, null=True)
    inventory_audit = models.ForeignKey('InventoryAudit', models.DO_NOTHING)
    last_updated = models.DateTimeField(blank=True, null=True)
    patient_ancillary_care = models.ForeignKey('PatientAncillaryCare', models.DO_NOTHING)
    stock_control_journal_entry = models.ForeignKey('GeneralJournal', models.DO_NOTHING, blank=True, null=True)
...
class Announcement(models.Model):
    ...
    last_updated = models.DateTimeField(blank=True, null=True)
    processed_by = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
...
class Appointment(models.Model):
    ...
    appointment_doctor = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
    appointment_type = models.CharField(max_length=255)
    booked_by = models.ForeignKey('SystemUser', models.DO_NOTHING)
    branch = models.ForeignKey('Branch', models.DO_NOTHING)
    ...
    referring_doctor = models.ForeignKey('SystemUser', models.DO_NOTHING)
...
class ApprovalActionAudit(models.Model):
    ...
    branch = models.ForeignKey('Branch', models.DO_NOTHING)
    cancelled_by = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
...
class Asset(models.Model):
    id = models.BigAutoField(primary_key=True)
    version = models.BigIntegerField()
    accumulated_depreciation_ledger = models.ForeignKey('ChartOfAccount', models.DO_NOTHING)
    ...
    date_created = models.DateTimeField(blank=True, null=True)
    depreciation_expense_ledger = models.ForeignKey('ChartOfAccount', models.DO_NOTHING)
    ...
    asset_assignee = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
...
class AssetDepreciation(models.Model):
    id = models.BigAutoField(primary_key=True)
    version = models.BigIntegerField()
    accumulated_depreciation_journal = models.ForeignKey('GeneralJournal', models.DO_NOTHING)
    ...
    depreciation_expense_journal = models.ForeignKey('GeneralJournal', models.DO_NOTHING)
    depreciation_percentage = models.DecimalField(max_digits=19, decimal_places=2)
    last_updated = models.DateTimeField(blank=True, null=True)
...
class AssetMaintenanceSchedule(models.Model):
    ...
    date_created = models.DateTimeField(blank=True, null=True)
    last_updated = models.DateTimeField(blank=True, null=True)
    maintenance_by = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
    maintenance_date = models.DateTimeField(blank=True, null=True)
    note = models.TextField(blank=True, null=True)
    received_by = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
    return_date = models.DateTimeField(blank=True, null=True)
    schedule_date = models.DateTimeField()
    scheduled_by = models.ForeignKey('SystemUser', models.DO_NOTHING)
...
class BankDeposit(models.Model):
    id = models.BigAutoField(primary_key=True)
    version = models.BigIntegerField()
    bank = models.ForeignKey('GeneralJournal', models.DO_NOTHING)
    branch = models.ForeignKey('Branch', models.DO_NOTHING)
    cash = models.ForeignKey('GeneralJournal', models.DO_NOTHING)
    company = models.ForeignKey('Company', models.DO_NOTHING)
    created_by = models.ForeignKey('SystemUser', models.DO_NOTHING)
    date_created = models.DateTimeField(blank=True, null=True)
...
class Branch(models.Model):
    id = models.BigAutoField(primary_key=True)
    version = models.BigIntegerField()
    claim_schedule_item = models.ForeignKey('Product', models.DO_NOTHING, blank=True, null=True)
    ...
    name = models.CharField(unique=True, max_length=255)
    payroll_deduction_item = models.ForeignKey('Product', models.DO_NOTHING, blank=True, null=True)
...
class BudgetPeriod(models.Model):
    ...
    branch = models.ForeignKey(Branch, models.DO_NOTHING)
    closed_by = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
...
class BulkDrugDispense(models.Model):
    ...
    created_by = models.ForeignKey('SystemUser', models.DO_NOTHING)
    date_created = models.DateTimeField(blank=True, null=True)
    dispensed_by = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
...
class ClinicSession(models.Model):
    ...
    in_behalf_of = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
    is_closed = models.BooleanField()
    last_updated = models.DateTimeField(blank=True, null=True)
...
class ConsultantFee(models.Model):
    ...
    branch = models.ForeignKey(Branch, models.DO_NOTHING)
    company = models.ForeignKey(Company, models.DO_NOTHING)
    consultant = models.ForeignKey('SystemUser', models.DO_NOTHING)
    created_by = models.ForeignKey('SystemUser', models.DO_NOTHING)
    date_created = models.DateTimeField(blank=True, null=True)
    description = models.TextField(blank=True, null=True)
...
class EarningLedgerLinkage(models.Model):
    ...
    created_by = models.ForeignKey('SystemUser', models.DO_NOTHING)
    date_created = models.DateTimeField(blank=True, null=True)
    default_credit_account = models.ForeignKey(ChartOfAccount, models.DO_NOTHING, blank=True, null=True)
    default_debit_account = models.ForeignKey(ChartOfAccount, models.DO_NOTHING)
    department = models.ForeignKey(Department, models.DO_NOTHING)
    earning = models.ForeignKey(Earning, models.DO_NOTHING)
    last_updated = models.DateTimeField(blank=True, null=True)
...
class EmployeeCarryForwardDays(models.Model):
    ...
    source_leave_period = models.ForeignKey('LeavePeriod', models.DO_NOTHING)
    utilization_leave_period = models.ForeignKey('LeavePeriod', models.DO_NOTHING)
...
class EmployeeConductBooking(models.Model):
    ...
    follow_up_lead = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
    follow_up_meeting_notes = models.TextField(blank=True, null=True)
    initial_meeting_lead = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
    ...
    review_lead = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
    ...
    suspension_processed_by = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
...
class EmployeeReportingTo(models.Model):
    ...
    subordinate = models.ForeignKey(Employee, models.DO_NOTHING)
    supervisor = models.ForeignKey(Employee, models.DO_NOTHING)
...
class EmployeeTenure(models.Model):
    ...
    tenure_processed_by = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
    tenure_processing_date = models.DateTimeField(blank=True, null=True)
    terminated_by = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
    ...
    termination_processed_by = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
...
class FinancialPeriod(models.Model):
    ...
    last_updated = models.DateTimeField(blank=True, null=True)
    locked_by = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
...
class FloatMovement(models.Model):
    ...
    company = models.ForeignKey(Company, models.DO_NOTHING)
    created_by = models.ForeignKey('SystemUser', models.DO_NOTHING)
    credited_account = models.ForeignKey('GeneralJournal', models.DO_NOTHING, blank=True, null=True)
    date_created = models.DateTimeField(blank=True, null=True)
    debited_account = models.ForeignKey('GeneralJournal', models.DO_NOTHING, blank=True, null=True)
    last_updated = models.DateTimeField(blank=True, null=True)
...
class InsuranceScheme(models.Model):
    ...
    last_updated = models.DateTimeField(blank=True, null=True)
    name = models.CharField(max_length=255)
    overpayment_ledger_account = models.ForeignKey(ChartOfAccount, models.DO_NOTHING, blank=True, null=True)
...
class InternalInventoryUsage(models.Model):
    ...
    issued_by = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
...
class Invoice(models.Model):
    ...
    verified_by = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
    void_status = models.TextField(blank=True, null=True)
...
class InvoiceLine(models.Model):
    id = models.BigAutoField(primary_key=True)
    version = models.BigIntegerField()
    account_receivable = models.ForeignKey(GeneralJournal, models.DO_NOTHING, blank=True, null=True)
    ...
    product = models.ForeignKey('Product', models.DO_NOTHING)
    quantity = models.DecimalField(max_digits=19, decimal_places=2)
    sale = models.ForeignKey(GeneralJournal, models.DO_NOTHING, blank=True, null=True)
    status = models.CharField(max_length=7)
    ...
    void_status = models.TextField(blank=True, null=True)
    specialist = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
...
class PatientAdmission(models.Model):
    ...
    discharge_date = models.DateTimeField(blank=True, null=True)
    discharge_encounter = models.ForeignKey(Encounter, models.DO_NOTHING, blank=True, null=True)
    ...
    escorting_nurse = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
    is_closed = models.BooleanField()
    last_updated = models.DateTimeField(blank=True, null=True)
    medical_discharge_date = models.DateTimeField(blank=True, null=True)
    patient_visit = models.ForeignKey('PatientVisit', models.DO_NOTHING)
    receiving_nurse = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
    released_by = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
...
class PatientAncillaryCare(models.Model):
    ...
    annulled_by = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
    branch = models.ForeignKey(Branch, models.DO_NOTHING)
    comment = models.TextField(blank=True, null=True)
    company = models.ForeignKey(Company, models.DO_NOTHING)
    created_by = models.ForeignKey('SystemUser', models.DO_NOTHING)
...
class PatientExternalReferral(models.Model):
    ...
    call_made_by = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
...
class PatientImaging(models.Model):
    ...
    annulled_at = models.DateTimeField(blank=True, null=True)
    annulled_by = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
    attended_by = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
    branch = models.ForeignKey(Branch, models.DO_NOTHING)
    company = models.ForeignKey(Company, models.DO_NOTHING)
    created_by = models.ForeignKey('SystemUser', models.DO_NOTHING)
    date_created = models.DateTimeField()
...
class PatientLabTest(models.Model):
    ...
    sample_collected_by = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
    sample_collection_time = models.DateTimeField(blank=True, null=True)
    sample_rejected_by = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
...
class PatientLabourMonitor(models.Model):
    ...
    created_by = models.ForeignKey('SystemUser', models.DO_NOTHING)
    date_created = models.DateTimeField(blank=True, null=True)
    delivered_by = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
...
class PatientMinorTheaterPatientMinorTheater(models.Model):
    patient_minor_theater_patient_minor_theater_items = models.ForeignKey(PatientMinorTheater, models.DO_NOTHING, blank=True, null=True)
    patient_minor_theater = models.ForeignKey(PatientMinorTheater, models.DO_NOTHING, blank=True, null=True)
...
class PatientRelationship(models.Model):
    ...
    last_updated = models.DateTimeField(blank=True, null=True)
    persona = models.ForeignKey(Patient, models.DO_NOTHING)
    personb = models.ForeignKey(Patient, models.DO_NOTHING)
...
class PayrollPeriod(models.Model):
    id = models.BigAutoField(primary_key=True)
    version = models.BigIntegerField()
    bank_schedule_by = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
    ...
    prepared_by = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
...
class PerformanceReview(models.Model):
    ...
    due_date = models.DateTimeField()
    employee = models.ForeignKey('SystemUser', models.DO_NOTHING)
    employee_department_unit = models.ForeignKey(Department, models.DO_NOTHING)
    employee_job_title = models.ForeignKey(JobTitle, models.DO_NOTHING)
    end_date = models.DateTimeField()
    last_updated = models.DateTimeField(blank=True, null=True)
    reviewer = models.ForeignKey('SystemUser', models.DO_NOTHING)
    reviewer_department_unit = models.ForeignKey(Department, models.DO_NOTHING)
    reviewer_job_title = models.ForeignKey(JobTitle, models.DO_NOTHING)
    start_date = models.DateTimeField()
...
class PerformanceReviewKeyIndicator(models.Model):
    ...
    employee_rating = models.ForeignKey(PerformanceIndicatorResponseTypeOption, models.DO_NOTHING, blank=True, null=True)
    key_performance_indicator = models.ForeignKey(KeyPerformanceIndicator, models.DO_NOTHING)
    ...
    reviewer_rating = models.ForeignKey(PerformanceIndicatorResponseTypeOption, models.DO_NOTHING, blank=True, null=True)
...
class PostOpChecklist(models.Model):
    ...
    patient_major_theater = models.ForeignKey(PatientMajorTheater, models.DO_NOTHING)
    scrub_nurse = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
...
class Product(models.Model):
    ...
    date_created = models.DateTimeField(blank=True, null=True)
    description = models.TextField(blank=True, null=True)
    dispensing_unit = models.ForeignKey(InventoryUnit, models.DO_NOTHING, blank=True, null=True)
    is_available = models.BooleanField()
    is_cost_fixed = models.BooleanField()
    is_system_defined = models.BooleanField()
    last_updated = models.DateTimeField(blank=True, null=True)
    name = models.CharField(max_length=255)
    product = models.ForeignKey('self', models.DO_NOTHING, blank=True, null=True)
    product_category = models.ForeignKey('ProductCategory', models.DO_NOTHING)
    product_type = models.CharField(max_length=10)
    purchase_cr_ledger_account = models.ForeignKey(ChartOfAccount, models.DO_NOTHING, blank=True, null=True)
    purchase_dr_ledger_account = models.ForeignKey(ChartOfAccount, models.DO_NOTHING, blank=True, null=True)
    qty_per_unit = models.IntegerField()
    receiving_unit = models.ForeignKey(InventoryUnit, models.DO_NOTHING, blank=True, null=True)
    saleipcr_ledger_account = models.ForeignKey(ChartOfAccount, models.DO_NOTHING, blank=True, null=True)
    saleipdr_ledger_account = models.ForeignKey(ChartOfAccount, models.DO_NOTHING, blank=True, null=True)
    saleopcr_ledger_account = models.ForeignKey(ChartOfAccount, models.DO_NOTHING, blank=True, null=True)
    saleopdr_ledger_account = models.ForeignKey(ChartOfAccount, models.DO_NOTHING, blank=True, null=True)
...
class ProjectFinancingLine(models.Model):
    ...
    date_created = models.DateTimeField(blank=True, null=True)
    description = models.TextField(blank=True, null=True)
    direct_expense = models.ForeignKey(GeneralLedger, models.DO_NOTHING, blank=True, null=True)
    direct_income = models.ForeignKey(GeneralLedger, models.DO_NOTHING, blank=True, null=True)
    invoice = models.ForeignKey(Invoice, models.DO_NOTHING, blank=True, null=True)
    last_updated = models.DateTimeField(blank=True, null=True)
...
class PurchaseOrder(models.Model):
    ...
    approval_date = models.DateTimeField(blank=True, null=True)
    approved = models.CharField(max_length=16, blank=True, null=True)
    approved_by = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
    branch = models.ForeignKey(Branch, models.DO_NOTHING)
    company = models.ForeignKey(Company, models.DO_NOTHING)
    created_by = models.ForeignKey('SystemUser', models.DO_NOTHING)
    date_created = models.DateTimeField(blank=True, null=True)
...
class Room(models.Model):
    ...
    date_created = models.DateTimeField(blank=True, null=True)
    description = models.TextField(blank=True, null=True)
    in_charge = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
    is_system_defined = models.BooleanField()
    last_updated = models.DateTimeField(blank=True, null=True)
    name = models.CharField(max_length=255)
    ward = models.ForeignKey('Ward', models.DO_NOTHING)
...
class ScaleEarningRate(models.Model):
    ...
    reference_earning = models.ForeignKey(ScaleEarning, models.DO_NOTHING, blank=True, null=True)
    scale_earning = models.ForeignKey(ScaleEarning, models.DO_NOTHING)
...
class Store(models.Model):
    ...
    name = models.CharField(max_length=255)
    parent_id = models.BigIntegerField()
    stock_control_account = models.ForeignKey(ChartOfAccount, models.DO_NOTHING, blank=True, null=True)
    adjustment_control_ledger = models.ForeignKey(ChartOfAccount, models.DO_NOTHING, blank=True, null=True)
...
class StoreManager(models.Model):
    ...
    date_created = models.DateTimeField()
    last_updated = models.DateTimeField()
    manager = models.ForeignKey('SystemUser', models.DO_NOTHING)
    store = models.ForeignKey(Store, models.DO_NOTHING)
...
class StoreReceipt(models.Model):
    ...
    delivering_staff = models.ForeignKey('SystemUser', models.DO_NOTHING, blank=True, null=True)
...
class StoreRequisitionItem(models.Model):
    ...
    created_by = models.ForeignKey('SystemUser', models.DO_NOTHING)
    date_created = models.DateTimeField(blank=True, null=True)
    destination_stock_control_journal_entry = models.ForeignKey(GeneralJournal, models.DO_NOTHING, blank=True, null=True)
    expected_quantity = models.DecimalField(max_digits=19, decimal_places=2)
    last_updated = models.DateTimeField(blank=True, null=True)
    product = models.ForeignKey(Product, models.DO_NOTHING)
    quantity = models.DecimalField(max_digits=19, decimal_places=2)
    source_stock_control_journal_entry = models.ForeignKey(GeneralJournal, models.DO_NOTHING, blank=True, null=True)
...
class Training(models.Model):
    ...
    version = models.BigIntegerField()
    branch = models.ForeignKey(Branch, models.DO_NOTHING)
    coordinator = models.ForeignKey(SystemUser, models.DO_NOTHING)
...
class TrainingAttendant(models.Model):
    ...
    employee = models.ForeignKey(SystemUser, models.DO_NOTHING)
    last_updated = models.DateTimeField(blank=True, null=True)
    training = models.ForeignKey(Training, models.DO_NOTHING)
...
class TrainingMaterialTrainingMaterial(models.Model):
    training_material_training_material_documents = models.ForeignKey(TrainingMaterial, models.DO_NOTHING, blank=True, null=True)
    training_material = models.ForeignKey(TrainingMaterial, models.DO_NOTHING, blank=True, null=True)
...
class Voucher(models.Model):
    ...
    status = models.CharField(max_length=7)
    supplier = models.ForeignKey(Supplier, models.DO_NOTHING)
    supplier_delivery_note = models.ForeignKey(SystemFile, models.DO_NOTHING, blank=True, null=True)
    supplier_invoice = models.ForeignKey(SystemFile, models.DO_NOTHING, blank=True, null=True)
    void_status = models.TextField(blank=True, null=True)
...
class VoucherLine(models.Model):
    id = models.BigAutoField(primary_key=True)
    version = models.BigIntegerField()
    account_payable = models.ForeignKey(GeneralJournal, models.DO_NOTHING, blank=True, null=True)
    branch = models.ForeignKey(Branch, models.DO_NOTHING)
    budget_line = models.ForeignKey(BudgetLine, models.DO_NOTHING, blank=True, null=True)
    company = models.ForeignKey(Company, models.DO_NOTHING)
    created_by = models.ForeignKey(SystemUser, models.DO_NOTHING)
    ...
    product = models.ForeignKey(Product, models.DO_NOTHING, blank=True, null=True)
    purchase = models.ForeignKey(GeneralJournal, models.DO_NOTHING, blank=True, null=True)
